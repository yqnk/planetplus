...
void planetplus_setup()
{
    ...
    cli_tools::print_info("Leave blank (whitespace) if you don't know, you will be able to change it later. See --help.\n");

    config::Config config(config_path + "config.conf");
    config.load();

    std::string owner = cli_tools::get_input("Enter the server owner ID: ");
